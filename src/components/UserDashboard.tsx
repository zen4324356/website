...
import { Search, Eye, EyeOff, LogIn, Filter, Database, RefreshCw, Mail, Calendar, AlertTriangle, CheckCircle, User, Clock } from "lucide-react";
        ...
        <div className="max-w-4xl mx-auto">
          ...
          {filterToEmail.trim() && (
            <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="text-gray-400 hover:text-netflix-white"
                        title={email.isHidden ? "Unhide Email" : "Hide Email"}
                      >
                        {email.isHidden ? <Eye className="h-4 w-4" /> : <EyeOff className="h-4 w-4" />}
                      </button>
                    </div>
                  </div>
              ...
              {displayEmails.length === 0 && filterToEmail && (
                <div className="bg-netflix-darkgray p-8 rounded-lg text-center netflix-fade-in">
                  <AlertTriangle className="h-12 w-12 text-netflix-red mx-auto mb-4" />
                  <h3 className="text-xl font-medium mb-2">No Matching Emails Found</h3>
                  <p className="text-gray-400 mb-4">
                    We couldn't find any emails matching "{filterToEmail}" in the recipient field.
                  </p>
                  <Button onClick={() => setFilterToEmail("")} className="netflix-button">
                    Clear Filter
                  </Button>
                </div>
              )}
